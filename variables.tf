...
variable "ingress_with_cidr_blocks" {
  ...
  default     = []
  description = "List of ingress rules to create where `cidr_block` is used.The values of map is fully complated with `security_group_rule` resource."
}

variable "egress_with_cidr_blocks" {
  type        = list(map(string))
  default     = []
  description = "List of egress rules to create where `cidr_block` is used.The values of map is fully complated with `security_group_rule` resource."
}
# security_group end
# cvm instance begin
